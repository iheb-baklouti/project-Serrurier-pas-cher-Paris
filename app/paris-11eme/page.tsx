...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: 'https://www.serrurier-pas-cher.paris/icon.svg', alt: "Serrurier pas cher Paris 11ème - Bastille" }],
    },
    twitter: {
    ...
    alternates: {
      canonical: 'https://www.serrurier-pas-cher.paris/paris-11eme',
    },
    other: {
      'geo.region': 'FR-75',
      'geo.placename': 'Paris 11ème',
