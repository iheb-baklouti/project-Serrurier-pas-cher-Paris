...
export default function Paris2emeLayout({
  children,
}: {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Serrurier pas cher Paris 2ème',
            image: 'https://www.serrurier-pas-cher.paris/logo.png',
            '@id': 'https://www.serrurier-pas-cher.paris/paris-2eme',
            ...
            areaServed: { '@type': 'City', name: 'Paris 2ème' },
            serviceArea: {
              '@type': 'GeoCircle',
              geoMidpoint: { '@type': 'GeoCoordinates', latitude: 48.8698, longitude: 2.3412 },
            },
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Paris 2ème', item: 'https://www.serrurier-pas-cher.paris/paris-2eme' },
            ],
          }),
        }}
      />
