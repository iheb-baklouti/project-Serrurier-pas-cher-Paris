...
export default function Paris19emeLayout({
  children,
}: {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Serrurier pas cher Paris 19ème',
            image: 'https://www.serrurier-pas-cher.paris/logo.png',
            '@id': 'https://www.serrurier-pas-cher.paris/paris-19eme',
            ...
            areaServed: { '@type': 'City', name: 'Paris 19ème' },
            serviceArea: {
              '@type': 'GeoCircle',
              geoMidpoint: { '@type': 'GeoCoordinates', latitude: 48.8827, longitude: 2.3745 },
            },
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Paris 19ème', item: 'https://www.serrurier-pas-cher.paris/paris-19eme' },
            ],
          }),
        }}
      />
