...
export default function Paris17emeLayout({
  children,
}: {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Serrurier pas cher Paris 17ème',
            image: 'https://www.serrurier-pas-cher.paris/logo.png',
            '@id': 'https://www.serrurier-pas-cher.paris/paris-17eme',
            ...
            areaServed: { '@type': 'City', name: 'Paris 17ème' },
            serviceArea: {
              '@type': 'GeoCircle',
              geoMidpoint: { '@type': 'GeoCoordinates', latitude: 48.8846, longitude: 2.3217 },
            },
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Paris 17ème', item: 'https://www.serrurier-pas-cher.paris/paris-17eme' },
            ],
          }),
        }}
      />
