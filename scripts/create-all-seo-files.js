...
export const metadata: Metadata = {
  ...
  description: 'Serrurier pas cher Paris ${arr.name} ⚡ Dépannage serrurier urgent 24h/24, ouverture de porte dès 95€. Artisan serrurier qualifié ${arr.name} arrondissement. Urgence serrurerie. Devis gratuit ☎️ 06 35 35 51 58',
