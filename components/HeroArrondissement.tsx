          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
              ...
              <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
                ...
                <span>Paris {arrondissement}</span>
              </div>
              <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
          ...
          <div className="relative lg:order-2">
            <div className="bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900/50 dark:to-blue-800/50 rounded-2xl p-8 h-96 flex items-center justify-center">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-2">Serrurier Paris {arrondissement}</h3>
...
export default HeroArrondissement;
